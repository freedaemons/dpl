CREATE TABLE "ECASMGR"."ECAS_HDB_CP_ARCHIVE" (
...
/
ALTER TABLE "ECASMGR"."ECAS_HDB_CP_ARCHIVE"
...
/
CREATE TABLE "ECASMGR"."ECAS_HDB_CP_LOT_ARCHIVE" (
	carpark_no              VARCHAR2(5) NOT NULL,
...
/
ALTER TABLE "ECASMGR"."ECAS_HDB_CP_LOT_ARCHIVE"
